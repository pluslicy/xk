<template>
  <div class="device">
    ...
    >
      <div slot="content">
        <el-form ref="deviceForm" :model="form" :rules="rules" label-width="80px">
          ...
          <el-form-item label="设备类型" prop="deviceTypeId">
            <el-select v-model="form.deviceTypeId">
              <el-option v-for="type in deviceTypeData.list" :key="type.id" :label="type.name" :value="type.id" />
            </el-select>
          </el-form-item>
