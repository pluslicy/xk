<template>
  <div class="repairs">
    ...
    <el-table v-loading="loading" size="small" :data="workerData.list">
      ...
      <el-table-column label="设备编号" prop="device.code" min-width="100" align="left" fixed="left" />
      <el-table-column label="设备名称" prop="device.name" min-width="200" align="left" fixed="left" />
