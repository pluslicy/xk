<template>
  <div class="spare">
    ...
    <!-- 按钮 -->
    <!-- 表格 -->
    <el-table v-loading="loading" size="small" :data="spareData.list">
    ...
    >
      <div slot="content">
        <el-form ref="spareForm" :model="form" :rules="rules" label-width="80px">
