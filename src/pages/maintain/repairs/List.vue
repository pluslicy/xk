  ...
  <div class="repairs">
    ...
    <el-table v-loading="loading" size="small" :data="repairsData.list">
      ...
      <el-table-column label="操作" width="100" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button type="text" size="mini" :disabled="!(scope.row.status == '未受理')" @click="toHandle(scope.row)">受理</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 表格 -->
    ...
    >
      <div slot="content">
        ...
        <el-form ref="workerForm" :model="form" :rules="rules" label-width="80px">
          <el-form-item v-if="form.user" label="报修人">
            {{ form.user.realname }}
          </el-form-item>
          ...
          <el-form-item v-if="form.device" label="故障设备">
