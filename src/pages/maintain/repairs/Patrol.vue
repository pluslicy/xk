<template>
  <div class="device_patrol">
    ...
    <!-- 按钮 -->
    <!-- 表格 -->
    <el-table v-loading="loading" size="small" :data="deviceData.list">
      <el-table-column label="序号" type="index" :index="1" fixed="left" />
      <el-table-column label="设备编号" prop="code" width="100" fixed="left" />
      <el-table-column label="名称" prop="name" min-width="240" />
      <el-table-column label="设备类型" prop="deviceType.name" width="140" />
      <el-table-column label="价格" prop="price" width="80" />
      <el-table-column label="参数" prop="parameters" width="160" />
      <el-table-column label="安装地点" prop="installAddress" width="160" />
      ...
      <el-table-column label="介绍" prop="introduce" min-width="200" />
    ...
    >
      <div slot="content">
        <el-form ref="deviceForm" :model="repair" size="mini" :rules="rules" label-width="80px">
          ...
          <el-form-item label="指派工人" prop="userId">
            <el-select v-model="repair.userId">
              <el-option v-for="user in usersData.list" :key="user.id" :value="user.id" :label="user.realname" />
            </el-select>
          </el-form-item>
          <el-form-item label="巡检要求" prop="patrolIntroduce">
            <el-input v-model="repair.patrolIntroduce" type="textarea" />
          </el-form-item>
