<template>
  <div class="sign">
    ...
    <!-- 按钮 -->
    <!-- 表格 -->
    <el-table v-loading="loading" size="small" :data="signData.list">
      ...
      <el-table-column label="签到地点" prop="signLocation" min-width="140" />
