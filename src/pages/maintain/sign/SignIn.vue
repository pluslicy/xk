  ...
  <div class="sign_form">
    <div class="sign_info">
      <el-form label-width="90px" size="small">
        ...
        <el-form-item label="当前地址：" v-if="visible">
          {{ form.signLocation }}
        </el-form-item>
        <el-form-item label="当前地址：" v-else >
          <el-input v-model="form.signLocation" placeholder="请手动输入地址"></el-input>
        </el-form-item>
      </el-form>
    </div>
    <!-- 百度地图 -->
    <BriupMap @loaded="loadedHandler" @onError="errorHandler" ></BriupMap>
